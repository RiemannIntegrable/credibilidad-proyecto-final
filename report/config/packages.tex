...
% inputenc no es necesario con XeLaTeX (utf8 nativo)
\usepackage{fontspec}
% Para XeLaTeX con soporte de español
% es-lcroman: usa números romanos minúsculas SIN small caps (evita conflicto con lastpage)
...
\usepackage{amssymb}
\usepackage{amsfonts}
% \usepackage{arev}  % Comentado: causa problemas con XeLaTeX (fuente Type1 incompatible)
