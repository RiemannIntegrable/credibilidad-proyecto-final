...
% Nombre del producto para metadatos PDF (sin comandos matemáticos)
\newcommand{\nombreProductoPDF}{}
\newcommand{\setNombreProductoPDF}[1]{\renewcommand{\nombreProductoPDF}{#1}}
    ...
    \begin{titlepage}
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \node[inner sep=0pt] at ([yshift=1cm]current page.center) {%
                \includegraphics[width=\paperwidth,height=0.45\paperheight,keepaspectratio=false]{images/compliance.png}%
            };
        \end{tikzpicture}
